...
输入为 JSON 数组，每项含 id、source、title、body。请输出 JSON 数组，每项：
{{"id": <同输入id>, "relevance": "high|medium|low|noise", "risk_types": ["投诉维权","产品质量","服务","舆情扩散","监管","其他"...], "summary": "一句话摘要", "subject_hits": ["命中的别名"], "sentiment": "positive|neutral|negative", "sentiment_score": -1.0到1.0的小数}}
